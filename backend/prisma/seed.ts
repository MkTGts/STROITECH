...
async function _seedCategories(): Promise<void> {
  const categories = [
    { name: "Строители", type: "builders", children: ["Бригады", "Отделочники", "Электрики", "Сантехники", "Кровельщики", "Фасадчики"] },
    { name: "Материалы", type: "materials", children: ["Кирпич и блоки", "Бетон и цемент", "Пиломатериалы", "Кровельные материалы", "Отделочные материалы", "Инженерные системы"] },
    { name: "Земля и недвижимость", type: "land", children: ["Участки", "Дома", "Коммерческая недвижимость"] },
    { name: "Техника", type: "equipment", children: ["Экскаваторы", "Краны", "Самосвалы", "Бетононасосы", "Леса и опалубка", "Инструмент"] },
  ];
