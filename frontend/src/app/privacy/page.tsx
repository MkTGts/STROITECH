        ...
        <div className="mt-10 space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              Для анализа посещений и улучшения работы сайта может применяться Яндекс.Метрика. Счетчик
              собирает технические данные о взаимодействии с сайтом (в том числе функции карты кликов
              (clickmap) и вебвизора (webvisor)). Использование Метрики включено в рамках соответствующих
              настроек аналитики и не предназначено для рекламы без вашего согласия.
            </p>
          </section>
